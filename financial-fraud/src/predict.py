...
def predict_and_evaluate(data_path, model_path):
...
# 3. Use predict_proba instead of predict to apply your custom threshold
    ...
    y_pred_custom = (y_probs > 0.2971).astype(int)
...
if __name__ == "__main__":
    predict_and_evaluate("../data/Synthetic_Financial_datasets_log.csv", "../models/fraud_model.joblib")
