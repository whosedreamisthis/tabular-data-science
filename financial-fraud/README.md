...
## Model Performance
The current iteration prioritizes **Recall** to ensure a higher percentage of fraudulent transactions are captured.
...
* **False Positives:** While Recall has improved to ~0.53, the model currently flags a significant number of legitimate transactions. Future iterations will involve a cost-benefit analysis to determine the optimal decision threshold for business-specific risk tolerance.
